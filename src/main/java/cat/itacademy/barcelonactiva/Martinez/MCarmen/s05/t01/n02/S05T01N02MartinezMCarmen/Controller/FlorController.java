...
public class FlorController {
    ...
    @GetMapping("/getAll")
    @ApiOperation(value="Mostrar totes les flors")
    public List<FlorDTO> getAllFlors(){
        return florService.getAll();
    }
    @GetMapping("/getOne/{id}")
    @ApiOperation(value="Mostra una flor per id")
    ...
    @PostMapping("/add")
    @ApiOperation(value="Afegeix una flor")
    ...
    @ApiOperation(value="Actualitza una flor")
    ...
    @ApiOperation(value="Borrar una flor per id")
